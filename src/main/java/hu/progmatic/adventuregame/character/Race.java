...
public enum Race {
    ...
    ELF("https://i.imgur.com/13NVorA.png",
            ...
            List.of(
                    ...
                    Item.builder().itemName("Elixir of Immortality").typeOfItem(ItemEnum.CONSUMABLE).description("Strengthens your vitality!(30 DMG, -30 MP)").mp(30).damage(30).build(),
                    Item.builder().itemName("Scroll of Thousand Calamities").typeOfItem(ItemEnum.CONSUMABLE).description("Unleashes chaotic forces!(40 DMG, -40 MP)").mp(40).damage(40).build()
            )
    ...
    Race(String img, String description, Integer hp, Integer mp, Integer gold, Integer attack, Integer defence, List<Item> activeItems, List<Item> invItems, String indexImg) {
        this.img = img;
