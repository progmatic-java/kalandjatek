    ...
    List<NPC> getInitNpcs() {
        ...
        witchKing.setItems(List.of(
                Item.builder()
                        ...
                        .mp(35)
                        .damage(40)
                        .description("Powerful spells that help you achieve your goals.(-35 MP, 40 DMG)")
                        .inventory(witchKing)
                        .build(),
                Item.builder()
                ...
                Item.builder()
                        ...
                        .typeOfItem(ItemEnum.ATTACK)
                        .description("A powerful weapon that executes decapitation with a clean-cut.(+8 ATK, 20 DMG)")
                        .inventory(witchKing)
                        .value(400)
                        .attack(8)
                        .damage(20)
    ...
    List<Item> getInitItems() {
        return List.of(
                Item.builder()
                        ...
                        .description("Blood-red delicacy from the Underworld.(+20 HP)")
                ...
                Item.builder()
                        .itemName("Stake")
                        .description("You better take it with you.(+2 ATK, 2 DMG)")
                        .typeOfItem(ItemEnum.ATTACK)
                        .value(0)
                        .damage(2)
                        .attack(2)
