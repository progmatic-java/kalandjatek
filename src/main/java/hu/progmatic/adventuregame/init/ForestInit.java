...
public class ForestInit extends InitRoom {
    ...
    public String getName() {
        return "The Dark Forest of Ka’am\n";
    }

    @Override
    List<NPC> getInitNpcs() {
        return List.of(NPC.builder().name("Ugly Troll").description("As big and ugly as trolls get!").build(),
                NPC.builder().name("X-epson").description("A being from another dimension that haunts the forest.").build());
    }
    ...
    List<Item> getInitItems() {
        return List.of(
                Item.builder()
                        ...
                        .description("I should not eat this, but it taste so good.")
